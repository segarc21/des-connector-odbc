...
/**
  ...
  @c repl_mysql_mutex_t is a drop-in replacement for @c my_mutex_t.
  @sa mysql_mutex_assert_owner
  @sa mysql_mutex_assert_not_owner
  @sa mysql_mutex_init
  @sa def_mysql_mutex_lock
  @sa def_mysql_mutex_unlock
  @sa mysql_mutex_destroy
*/
struct repl_mysql_mutex_t {
  /** The real mutex. */
  mysql_mutex_t m_mutex;
  /**
    The instrumentation hook.
    Note that this hook is not conditionally defined,
    for binary compatibility of the @c repl_mysql_mutex_t interface.
  */
