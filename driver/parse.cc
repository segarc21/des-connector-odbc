...
static const MY_STRING process = {"/PROCESS", 8, 8};
...
static const MY_STRING del = {"DELETE", 6, 6};
...
#endif
                                              {
                                                &process, &select_, &insert, &update, &del,
...
BOOL case_compare(DES_PARSED_QUERY *pq, const char *pos, const MY_STRING *str)
{
